...
ehr_data_dir = '/projects/eclarson/stems/STEMC/EHR/MIMIC/MIMICIV/physionet.org/files/mimiciv/data/phenotyping'

cxr_data_dir = '/projects/eclarson/stems/STEMC/EHR/MIMIC/physionet.org/content/mimic-cxr-jpg/get-zip/2.1.0/mimic-cxr-jpg-chest-radiographs-with-structured-labels-2.1.0'
